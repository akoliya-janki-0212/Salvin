...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url><loc>https://salvinindustries.in/index.html</loc><lastmod>2026-04-03</lastmod><changefreq>monthly</changefreq><priority>1.0</priority></url>
  <url><loc>https://salvinindustries.in/about.html</loc><lastmod>2026-04-03</lastmod><changefreq>monthly</changefreq><priority>0.8</priority></url>
  <url><loc>https://salvinindustries.in/machineries.html</loc><lastmod>2026-04-03</lastmod><changefreq>weekly</changefreq><priority>0.9</priority></url>
  <url><loc>https://salvinindustries.in/spares.html</loc><lastmod>2026-04-03</lastmod><changefreq>weekly</changefreq><priority>0.9</priority></url>
  <url><loc>https://salvinindustries.in/contact.html</loc><lastmod>2026-04-03</lastmod><changefreq>monthly</changefreq><priority>0.8</priority></url>
  <url><loc>https://salvinindustries.in/careers.html</loc><lastmod>2026-04-03</lastmod><changefreq>monthly</changefreq><priority>0.7</priority></url>`;
...
function cleanupRootDirectory(generatedUrls) {
    ...
    const protectedFiles = [
        ...
        'talkwithkeval.html', 'case-studies.html', 'coaching.html',
...
async function buildMachineries() {
    ...
    for (const record of machinesRaw) {
        ...
        const description = (machine.description || "Salvin Industries industrial machinery.").replace(/"/g, '&quot;');
...
async function buildSpares() {
    ...
    for (const record of sparesRaw) {
        ...
        const slug = slugify(name);
        const fileName = `${slug}_${pid}.html`;
        const description = (spare.description || spare.Description || "Industrial material by Salvin Industries.").replace(/"/g, '&quot;');
                ...
                <div class="details-content">
                    ...
                    <div class="product-details-summary mb-4">
                        <table class="specs-table-premium">
                            ...
                            <tr><td class="spec-label">Brand</td><td class="spec-value">${brandMap[spare.brand] || 'Salvin'}</td></tr>
